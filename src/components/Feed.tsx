{
  // Update the CompetitionCard component within Feed.tsx
  const updatedCompetitionCard = `
  function CompetitionCard({ title, prize, status, entryFee, genre, participants, deadline, description }) {
    return (
