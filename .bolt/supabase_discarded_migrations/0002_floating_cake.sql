...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'Donation' AND policyname = 'Users can view their own donations'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'Donation' AND policyname = 'Users can create donations'
  ) THEN
